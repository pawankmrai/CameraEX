...
- (IBAction)handlePan:(UIPinchGestureRecognizer *)recognizer;
@end
...
//    self.photo;
//    self.imageView;
//    self.cropRectangleButton;
//    self.infoButton;
//    self.infoMessageTitle;
//    self.infoMessageBody;
...
- (IBAction)handlePan:(UIPanGestureRecognizer *)recognizer {
    ...
    CGPoint translation = [recognizer translationInView:self.cropRectangleButton];
