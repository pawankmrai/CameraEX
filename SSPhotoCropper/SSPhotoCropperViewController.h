...
@interface SSPhotoCropperViewController: UIViewController<UIScrollViewDelegate>
{
    ...
    id<SSPhotoCropperDelegate> __unsafe_unretained delegate;
...
@property (nonatomic, strong) IBOutlet UIButton *cropRectangleButton;
@property (nonatomic, strong) IBOutlet UIButton *infoButton;
@property (nonatomic, unsafe_unretained) id<SSPhotoCropperDelegate> delegate;
@property (nonatomic, assign) CGFloat minZoomScale;
@property (nonatomic, assign) CGFloat maxZoomScale;
@property (nonatomic, strong) NSString *infoMessageTitle;
@property (nonatomic, strong) NSString *infoMessageBody;
